...
public class UploadParkLogic {
	...
	public static ReturnHead saveInfoParkAdmin(InfoParkAdminRepository infoParkAdminRepository,String json) throws JsonParseException, JsonMappingException, IOException, ParseException{
