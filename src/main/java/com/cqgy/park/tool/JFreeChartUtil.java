/**
 * @作者 admin
 * @时间 2016年5月30日 上午11:21:10
 * @类名 JFreeChart.java
 * @类描述 
 * @修改记录
 * 1、修改人 2016年5月30日 上午11:21:10
 *   修改描述
 */
...
public class JFreeChartUtil {
    ...
    private static final String CHART_PATH = CustomProps.getProp("file.temp.path")+"/";
    ...
    public String createBarChart(CategoryDataset dataset, String xName,
        ...
        try {
            String chartName = charName;
            fos_jpg = new FileOutputStream(chartName);
            ChartUtilities.writeChartAsPNG(fos_jpg, chart, 600, 400, true, 10);
            return chartName;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public String createValidityComparePimChar(PieDataset dataset,
        ...
        try {
            ...
            fos_jpg = new FileOutputStream(chartName);
            // 高宽的设置影响椭圆饼图的形状
            ChartUtilities.writeChartAsPNG(fos_jpg, chart, 600, 400);
